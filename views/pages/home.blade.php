            ...
            <div class="hero-badges-row">
                ...
                <div class="hero-badge-card spotlight-card">
                    ...
                    <div class="badge-body">
                        ...
                        <span class="badge-desc">{{ $company['website'] ?? 'www.liqulofi.com' }}</span>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="gold-box-frame cta-inner-box text-center">
            ...
            <div class="cta-buttons-center">
                <button type="button" class="btn-gold btn-xl open-modal-btn" data-modal="inquiry-modal">
                    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <a href="tel:+916232046473" class="btn-outline-gold btn-xl">
                    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2">
